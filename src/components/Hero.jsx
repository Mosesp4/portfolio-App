...
const Hero = () => {
  return (
    ...
    >
      <div className="text-center p-10  justify-end"  style={{ marginTop: "-2rem" }}>
      ...
      <div className="relative mx-auto bg-gradient-to-r from-orange-400 to-white rounded-full w-80 h-80 mt-2 md:h-96 md:w-96" >
        <img
          src={dev}
          alt="hero image"
